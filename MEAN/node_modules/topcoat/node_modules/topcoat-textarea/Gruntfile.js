...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        stylus: {
            mobilelight: {
                options: {
                    paths: ['node_modules/topcoat-textarea-base/src', 'node_modules/topcoat-utils/src/mixins', 'node_modules/topcoat-theme/src'],
                ...
                files: [{
                    ...
                    dest: 'css/topcoat-textarea-mobile-light.css'
                }]
            },
            ...
            mobiledark: {
                ...
                files: [{
                    src: 'src/topcoat-textarea.styl',
                    dest: 'css/topcoat-textarea-mobile-dark.css'
                }]
            },
            ...
            desktoplight: {
                ...
                files: [{
                    src: 'src/topcoat-textarea.styl',
                    dest: 'css/topcoat-textarea-desktop-light.css'
                }]
            },
            ...
            desktopdark: {
                ...
                files: [{
                    src: 'src/topcoat-textarea.styl',
                    dest: 'css/topcoat-textarea-desktop-dark.css'
                }]
            }
        },
